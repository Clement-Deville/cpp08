...
/*   Updated: 2025/05/06 18:06:16 by cdeville         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (std::distance(first, last) + this->_numbers_set.size() == this->_max_size)
        throw std::out_of_range("Span: Out of capacity");
...
//! WARNING, NEED TO FIX IT, NOT RETURNING A GOOD VALUE 
